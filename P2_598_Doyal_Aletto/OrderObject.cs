...
namespace P2_598_Doyal_Aletto
{
    ...
    {
        private string bookStoreId; //the identity of the sender
        ...
        public OrderObject(string sender, Int32 cNum, Int32 pubid, Int32 numBooks, double price)
        {
            bookStoreId = sender;
            cardNo = cNum;
            publisherId = pubid;
        ...
        public OrderObject(string sender, Int32 cNum, Int32 recId, Int32 numBooks, double price, DateTime now)
        {
            bookStoreId = sender;
            cardNo = cNum;
            publisherId = recId;
